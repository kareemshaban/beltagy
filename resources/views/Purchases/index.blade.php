                    ...
                    <div class="card">
                        <div class="card-header"
                            ...
                            <h5 class="card-title fw-semibold " style="margin-bottom: 0 !important; color: #3cacc8 ">{{
                                __('main.purchases') }}</h5>
                           <a href="{{route('purchases-create')}}"> <button type="button" class="btn btn-info btn-lg" style="display: flex ; align-items: center;" >
                            ...
                            <div class="table-wrapper">
                                <div class="table-responsive">
                                    <table class="table table-striped  table-bordered table-hover" id="table">
                                        ...
                                        <th class="text-center"> {{ __('main.remainAmount') }} </th>
                                        ...
                                        @foreach ( $purchases as $purchase )
                                            <tr>
                                                ...
                                                <td class="text-center"> {{ $purchase -> billNumber }} </td>
                                                <td class="text-center"> {{ $purchase -> client }} </td>
                                                <td class="text-center"> {{ \Carbon\Carbon::parse($purchase -> date) ->format('Y-m-d') }} </td>

                                                <td class="text-center"> {{ $purchase -> total }} </td>
                                                <td class="text-center"> {{ $purchase -> discount }} </td>
                                                <td class="text-center"> {{ $purchase -> net }} </td>
                                                <td class="text-center"> {{ $purchase -> paid}} </td>
                                                <td class="text-center"> {{ $purchase -> remain}} </td>
                                                <td class="text-center" >
                                                  <a href="{{route('purchases-view' , $purchase -> id)}}">
                                                    ...
                                                    <button type="button" style="border-radius: 15px ; height: 40px ; width: 70px" class="btn btn-danger deleteBtn" value="{{ $purchase -> id }}"> <iconify-icon icon="mynaui:trash-solid" style="font-size: 20px"></iconify-icon> </button>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
