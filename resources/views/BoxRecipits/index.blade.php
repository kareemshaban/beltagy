    ...
    <div class="body-wrapper edit_layout">
        ...
        <div class="body-wrapper-inner">
            <div class="container-fluid">
                        ...
                        <div class="table-wrapper">
                            <div class="table-responsive">
                                <table class="table table-striped  table-bordered table-hover" id="table">
                                    ...
                                    <th class="text-center"> {{ __('main.paymentType') }} </th>
                                    ...
                                    @foreach ( $docs as $doc )
                                        <tr>
                                            ...
                                            <td class="text-center"> {{ $doc -> paymentType }} </td>
                ...
                @include('BoxRecipits.create')
                @include('BoxRecipits.deleteModal')
                @include('BoxRecipits.view')
...
<script >
            ...
            success:function(response){
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        $(".modal-body #date").val(currentDate);
                        $(".modal-body #paymentType").val(response.paymentType);
    ...
    function confirmDelete(){
        let url = "{{ route('boxRecipits-destroy', ':id') }}";
