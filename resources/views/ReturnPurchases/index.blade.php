                    ...
                    <div class="card">
                        <div class="card-header"
                            ...
                            <h5 class="card-title fw-semibold " style="margin-bottom: 0 !important; color: #3cacc8 ">{{
                                __('main.return_purchase_bill') }}</h5>
                           <a href="{{route('returnPurchase-create')}}"> <button type="button" class="btn btn-info btn-lg" style="display: flex ; align-items: center;" >
                                    ...
                                    <table class="table table-striped  table-bordered table-hover" id="table">
                                        ...
                                        @foreach ( $purchases as $purchase )
                                            <tr>
                                                ...
                                                <td class="text-center"> {{ $purchase -> originalBillNumber }} </td>
                                                ...
                                                <td class="text-center" >
                                                    <a href="{{route('returnPurchase-view' , $purchase -> id)}}">
...
<script>
    ...
    function confirmDelete(){
        let url = "{{ route('returnPurchase-destroy', ':id') }}";
