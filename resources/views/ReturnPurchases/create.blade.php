    ...
    <div class="body-wrapper edit_layout">
        ...
        <div class="body-wrapper-inner">
            <div class="container-fluid">
                <form class="center" id="invoiceForm" name="invoiceForm" method="POST" action="{{ route('returnPurchase-store') }}"
                    ...
                    <div class="card">
                        <div class="card-header"
                            ...
                            <h5 class="card-title fw-semibold " style="margin-bottom: 0 !important; color: #3cacc8 ">{{
                                __('main.create_return_purchase_bill') }}</h5>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row" style="align-items: end ; margin-top: 5px">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label>{{ __('main.purchases') }}  </label>
                                        <select class="form-select @error('purchaseBillId') is-invalid @enderror" name="purchaseBillId" id="purchaseBillId" required>
                                            <option value=""> أختر الفاتورة </option>
                                            @foreach($purchases as $purchase)
                                                <option value="{{$purchase -> id}}"> {{$purchase -> billNumber}} </option>
                                            @endforeach
                                        </select>
                                        @error('purchaseBillId')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                        @enderror
