                    ...
                    <div class="card">
                        <div class="card-header"style="display: flex ; justify-content: space-between ; align-items: center">
                            <h5 class="card-title fw-semibold " style="margin-bottom: 0 !important; color: #3cacc8 ">{{
                                __('main.client_account_items') }}</h5>
                            ...
                            <div class="table-wrapper">
                                <div class="table-responsive">
                                    <table class="table table table-striped  table-bordered table-hover"  id="mtable">
                                        ...
                                        <th class="text-center"> {{ __('main.info') }} </th>
                                        ...
                                        @foreach ( $accounts as $account )
                                            <tr >
                                                ...
                                                <td class="text-center"> -- </td>
                                                <td class="text-center"> -- </td>
                                                <td class="text-center">  <span class="badge text-bg-warning"> الرصيد الإفتتاحي  </span> </td>
                                                <td class="text-center"> ----</td>
                                                <td class="text-center"> ---- </td>
                                                <td class="text-center"> ----</td>
                                                <td class="text-center"> ----</td>
                                        ...
                                        @endforeach
                                        @foreach ( $brfors as $brfor )
                                            <tr >
                                                <td class="text-center"> -- </td>
                                                <td class="text-center"> -- </td>
                                                <td class="text-center"> -- </td>
                                                <td class="text-center">  <span class="badge text-bg-warning"> رصيد ما قبل الفترة  </span> </td>
                                                <td class="text-center"> ----</td>
                                                <td class="text-center"> ---- </td>
                                                <td class="text-center"> ----</td>
                                                <td class="text-center"> ----</td>
                                                <td class="text-center text-danger" style="font-size: 15px ; font-weight: bold ;"> {{$brfor['credit']}} </td>
                                                <td class="text-center text-success" style="font-size: 15px ; font-weight: bold ;"> {{$brfor['debit']}} </td>

                                                <td style="font-size: 15px ; font-weight: bold ;" class="text-center @if( $brfor['debit'] - $brfor['credit'] > 0 )  text-success @else text-danger @endif"> {{  $brfor['debit'] - $brfor['credit']}} </td>
                                            </tr>
                                        @endforeach
                                        @foreach ( $data as $doc )
                                            <tr >
                                                ...
                                                <td class="text-center"> {{ $doc -> item_name}} </td>
                                                <td class="text-center"> {{ $doc -> quantity}} </td>
                                                <td class="text-center"> {{ $doc -> weight}} </td>
