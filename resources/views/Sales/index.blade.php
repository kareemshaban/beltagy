                    ...
                    <div class="card">
                        <div class="card-header"
                            ...
                            <h5 class="card-title fw-semibold " style="margin-bottom: 0 !important; color: #3cacc8 ">{{
                                __('main.sales') }}</h5>
                           <a href="{{route('sales-create')}}"> <button type="button" class="btn btn-info btn-lg" style="display: flex ; align-items: center;" >
                                    ...
                                    <table class="table table-striped  table-bordered table-hover" id="table">
                                        ...
                                        @foreach ( $sales as $sale )
                                            <tr>
                                                ...
                                                <td class="text-center"> {{ $sale -> net }} </td>
                                                <td class="text-center"> {{ $sale -> paid}} </td>
                                                <td class="text-center"> {{ $sale -> remain}} </td>
