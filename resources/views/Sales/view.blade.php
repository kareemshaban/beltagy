                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="billNumber" id="billNumber"
                                               ...
                                               placeholder="" autofocus  readonly value="{{$sales -> billNumber}}" />
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="text" id="date"
                                               ...
                                               placeholder="" autofocus readonly value="{{ \Carbon\Carbon::parse($sales -> date) -> format('Y-m-d')}}"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="client" id="client"
                                               class="form-control @error('client') is-invalid @enderror"
                                                autofocus readonly value="{{$sales -> client}}"/>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea  name="notes" id="notes" rows="3" disabled
                                                   ...
                                                   placeholder="{{ __('main.notes') }}" autofocus >{{$sales ->notes }}</textarea>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="total" id="total"
                                               ...
                                               placeholder="" autofocus  readonly required  value="{{$sales -> total}}"/>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" name="discount" id="discount"
                                               ...
                                               placeholder="" autofocus required readonly value="{{$sales -> discount}}"/>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="net" id="net"
                                               ...
                                               placeholder="" autofocus  readonly required value="{{$sales -> net}}"/>
