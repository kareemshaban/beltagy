...
<body>
        ...
        <div class="body-wrapper edit_layout">
            ...
            <div class="body-wrapper-inner">
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header"
                            ...
                            <h5 class="card-title fw-semibold " style="margin-bottom: 0 !important; color: #3cacc8 ">{{
                                __('main.financial_deduction_boins') }}</h5>
                    ...
                    @include('financialDeductionAndBonse.create')
                    @include('financialDeductionAndBonse.deleteModal')
                ...
                if(response){
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            $(".modal-body #reward").val(response.reward);
    ...
    function confirmDelete(){
        let url = "{{ route('financialDeductionAndBonse-destroy', ':id') }}";
