...
<body>
        ...
        <div class="body-wrapper edit_layout">
            ...
            <div class="body-wrapper-inner">
                <div class="container-fluid">
                                        ...
                                        @foreach ( $types as $type )
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <button type="button" class="btn btn-danger deleteBtn" value="{{ $type -> id }}"> <iconify-icon icon="mynaui:trash-solid" style="font-size: 25px"></iconify-icon> </button>
                                                    <button type="button" class="btn btn-success editBtn" value="{{ $type -> id }}"> <iconify-icon icon="akar-icons:edit" style="font-size: 25px"></iconify-icon> </button>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                    ...
                    @include('PaymentType.create')
                    @include('PaymentType.deleteModal')
    ...
    function confirmDelete(){
        let url = "{{ route('paymentTypes-destroy', ':id') }}";
